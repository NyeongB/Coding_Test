...
public class Solution_1_05
{
    public int func_a(int n){	// 10의 n 승 알고리즘 
        int ret = 1;
        while(n > 0){
            ret *= 10;
            n--;
    ...
    int func_b(int n){		// **숫자의 길이 구하는 알고리즘** 
        int ret = 0;
        while(n > 0){
            ret++;
            n /= 10;
    ...
    int func_c(int n){		// **숫자의 각자리수 합 더하는 알고리즘** 
        int ret = 0;
        while(n > 0){
            ret += n%10;
            n /= 10;
    ...
    public static void main(String[] args) {
    	Solution_1_05 sol = new Solution_1_05();
        int num1 = 1;
